		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	...
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					...
					<?php echo strtoupper(get_phrase('edit_bed_allotment'));?>
			...
			<li class="<?php if(!isset($edit_profile))echo 'active';?>">
            	...
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					...
					<?php echo strtoupper(get_phrase('bed_allotment_list'));?>
			...
			<li>
            	...
            	<a href="#add" data-toggle="tab"><i class="icon-plus"></i>
					...
					<?php echo strtoupper(get_phrase('add_bed_allotment'));?>
                    ...
                    <?php echo form_open('nurse/manage_bed_allotment/edit/do_update/'.$row['bed_allotment_id'] , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"><?php echo strtoupper(get_phrase('allotment_time'));?></label>
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"><?php echo strtoupper(get_phrase('discharge_time'));?></label>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-blue"><?php echo strtoupper(get_phrase('edit_bed_allotment'));?></button>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	...
                	<thead>
                		...
                		<tr>
                    		...
                    		<th><div><?php echo strtoupper(get_phrase('bed_type'));?></div></th>

                    		<th><div><?php echo strtoupper(get_phrase('patient'));?></div></th>

                    		<th><div><?php echo strtoupper(get_phrase('allotment_date_time'));?></div></th>

                    		<th><div><?php echo strtoupper(get_phrase('discharge_date_time'));?></div></th>
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('nurse/manage_bed_allotment/create/' , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn btn-blue"><?php echo strtoupper(get_phrase('add_bed_allotment'));?></button>
