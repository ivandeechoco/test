            ...
            <div class="action-nav-normal">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span2 action-nav-button">
                        ...
                        <span><?php echo strtoupper(get_phrase('doctor'));?></span>
                    ...
                    <div class="span2 action-nav-button">
                        ...
                        <span><?php echo strtoupper(get_phrase('appointment'));?></span>
                    ...
                    <div class="span2 action-nav-button">
                        ...
                        <span><?php echo strtoupper(get_phrase('prescription'));?></span>
                    ...
                    <div class="span2 action-nav-button">
                        ...
                        <span><?php echo strtoupper(get_phrase('admit_history'));?></span>
                    ...
                    <div class="span2 action-nav-button">
                        ...
                        <span><?php echo strtoupper(get_phrase('blood_bank'));?></span>
                    ...
                    <div class="span2 action-nav-button">
                        ...
                        <i class="icon-credit-card" style="color:#1f8e9d"></i>

                        <span><?php echo strtoupper(get_phrase('view_invoice'));?></span>
            ...
            <div class="box">
                ...
                <div class="box-header">
                    ...
                    <div class="title">
                        ...
                        <i class="icon-calendar"></i> <?php echo strtoupper(get_phrase('calendar_schedule'));?>
            ...
            <div class="box">
                ...
                <div class="box-header">
                    ...
                    <span class="title">
                        ...
                        <i class="icon-reorder"></i> <?php echo strtoupper(get_phrase('noticeboard'));?>
    ...
    $("#schedule_calendar").fullCalendar({
            ...
            events: [
...

					{
						...
						title: "<?php echo strtoupper(get_phrase('appointment')).' : '.$this->crud_model->get_type_name_by_id('doctor' ,$row['doctor_id'], 'name' );?>",
